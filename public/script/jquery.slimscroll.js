      ...
      var isOverPanel, isOverBar, isDragg, queueHide, touchDif,
        ...
        function scrollContent(y, isWheel, isJump)
        {
          ...
          if (isWheel)
          {
            ...
            bar.css({ top: (delta+ deltaDelta )+ 'px' });
          }
        ...
        function hideBar()
        {
          ...
          //Todo: find out why bar and rail top can not be set
          var topOffset=  o.positionType==='static' ? wrapper.position().top : 0;
          bar.css('top',topOffset);
          rail.css('top',topOffset);
