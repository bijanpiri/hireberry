...
(function($, window) {
  ...
  Tour = (function() {
    ...
    Tour.prototype.showStep = function(i) {
      ...
      showStepHelper = (function(_this) {
        return function(e) {
          ...
          if (step.backdrop) {
            _this._showBackdrop(!_this._isOrphan(step) ? step.element : void 0, step.container);
          }
          _this._scrollIntoView(step.element, function() {
            ...
            if ((step.element != null) && step.backdrop) {
              _this._showOverlayElement(step.element,step.container);
            }
    ...
    Tour.prototype._showBackdrop = function(element,container) {
      ...
      return $(container).append(this.backdrop);
    };
    ...
    Tour.prototype._showOverlayElement = function(element,container) {
      ...
      $background.width($element.outerWidth()).height($element.outerHeight()).addClass("tour-step-background").offset(offset);
